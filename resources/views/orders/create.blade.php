...
@section('content')
    ...
    <div class="container main">
        ...
        <div class="white_block" style="margin-top: 20px;">
            <form action="{{route('orders.store')}}" method="post" enctype="multipart/form-data" class="form form-big">
                <h2 class="form-title">{{__('main.make_order')}}</h2>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group-item">
                                ...
                                <input placeholder="3" id="days" required min="1" type="number" name="days" value="{{request()->old('days')}}" class="form-field">
                            </div>
                        </div>
